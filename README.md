...
Система автоматической генерации вертикальных видео (9:16) для TikTok/Reels на основе донорских роликов. Анализирует донорское видео, создаёт аватар с той же речью через HeyGen, генерирует динамичный B-roll через Kling и собирает финальное вертикальное видео (аватар внизу + B-roll фон) через Shotstack.
